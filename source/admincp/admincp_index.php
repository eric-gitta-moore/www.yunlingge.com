...
//2020-02-23 修改 不自动获取信息，手动点击刷新才获取
require_once libfile('function/cloudaddons');
$newversion = dunserialize($_G['setting']['cloudaddons_newversion']);
if (!is_array($newversion['newversion']))
{
    $newversion = [];
}
//empty($newversion['newversion']) || !is_array($newversion['newversion']) || abs($_G['timestamp'] - $newversion['updatetime']) > 86400 || 
