...
class lib_base 
{    
    public static $grab_host = 'http://bbs.share555.com/';
    public static $grab_vest_list = 'plugin.php?id=ror_user_vest_share&act=vest_list';
    public static $grab_vest_detail = 'plugin.php?id=ror_user_vest_share&act=vest_detail';
    public static $grab_vest_add = 'plugin.php?id=ror_user_vest_share&act=vest_add';
    public static $grab_vest_rand = 'plugin.php?id=ror_user_vest_share&act=vest_rand';
    public static $grab_api_host = 'http://share555.com/';
