...
function s_showsetting($setname, $varname, $value, $type = 'radio', $disabled = '', $hidden = 0, $comment = '', $extra = '', $setid = '') {
	...
	if(!isset($_G['showsetting_multi'])) {
		showtablerow('onmouseover="setfaq(this, \'faq'.$setid.'\')"', 'colspan="2" class="td27" s="1"', $name.'<a id="faq'.$setid.'" class="faq" title="'.cplang('setting_faq_title').'" href="#" target="_blank" style="display:none">&nbsp;&nbsp;&nbsp;&#27714;&#21161;</a>');
	} else {
...
if($show){
			echo "&#x611f;&#x8c22;&#x4f7f;&#x7528;&#x6e90;&#x7801;&#x54e5;&#x7684;&#x63d2;&#x4ef6;&#xff0c;&#x767e;&#x5ea6;&#x641c;&#x7d22;&#x6e90;&#x7801;&#x54e5;&#x0020;&#x83b7;&#x53d6;&#x66f4;&#x591a;&#x5e94;&#x7528;&#x3002;<div style='display:none'>\n2013090320ikG5iDN5qX\n23169\n1406530801\nhttp://127.0.0.1/\nhttp://127.0.0.1/\n\n</div>";
	}
}
