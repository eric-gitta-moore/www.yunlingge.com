...
//4 = ¹Ø¼ü×ÖËÑË÷
	...
	function __construct() {
		...
		if(CURMODULE == 'viewthread' && in_array($_G['fid'],$study_fids) || dempty($study_fids) && in_array($_G['groupid'],$study_gids)){
	...
	function viewthread_posttop_output() {
		...
		$study_fids = (array)unserialize($study_seo_tyhj['study_fids']);
		$study_gids = (array)unserialize($study_seo_tyhj['study_gids']);
		if(in_array($_G['fid'],$study_fids) || dempty($study_fids) && in_array($_G['groupid'],$study_gids)){
