...
if (typeof jQuery.fn.draggable === "undefined") {
    ...
    (function($) {
        ...
        $.fn.draggable = function() {
            ...
            ele.style.top = "121px";
            Drag.init(ele, null, 26, 900, 86, 86);
            return this;
        };
    ...
    gradx = {
        ...
        load_info: function(ele) {
            ...
            if (this.slider_ids.indexOf(ele.id) > -1) { //javascript does not has # in its id
                ...
                if (parseInt(left) > 26 && parseInt(left) < 900) {
        ...
        add_slider: function(sliders) {
            ...
            for (k in obj) {
                ...
                var delta = 26; //range: 26px tp 900px
        ...
        load_gradx: function(id, sliders) {
            ...
            var html = "<div class='gradx'>\n\
                        <div id='gradx_add_slider' class='gradx_add_slider gradx_btn'><i class='icon icon-add'></i>&#x65B0;&#x589E;</div>\n\
                        ...
                        <select id='gradx_gradient_type' class='gradx_gradient_type'>\n\
                            ...
                            <option value='ellipse'>&#x692D;&#x5706;&#x5F84;&#x5411;</option>\n\
                        </select>\n\
                        <select id='gradx_gradient_subtype' class='gradx_gradient_type'>\n\
                            <option id='gradx_gradient_subtype_desc' value='gradient-direction' disabled>&#x6E10;&#x53D8;&#x65B9;&#x5411;</option>\n\
                        ...
                        <div id='gradx_show_code' class='gradx_show_code gradx_btn'><i class='icon icon-file-css'></i><span>&#x663E;&#x793A;css&#x4EE3;&#x7801;</span></div>\n\
