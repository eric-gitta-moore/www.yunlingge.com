...
class plugin_zhuzhu_taobao {
	...
	function common() {
		...
		require_once(DISCUZ_ROOT.'/source/plugin/zhuzhu_taobao/function/function_core.php');
		
		$zhuzhu_rewrite = dunserialize($_G['setting']['zhuzhu_taobao']);
//        var_dump($zhuzhu_rewrite);
//        exit();
		if($zhuzhu_rewrite['taobao']['available']) {
			$_G['setting']['output']['preg']['search']['taobao'] = "/<a href\=\"plugin.php\?id\=zhuzhu_taobao\"([^\>]*)\>/e";
			$_G['setting']['output']['preg']['replace']['taobao'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao', 0)";
		}
		// return;
		if($zhuzhu_rewrite['taobao-tbk']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-tbk'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-tbk', 0)";
		}
		if($zhuzhu_rewrite['taobao-tbk-cat']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-tbk-cat'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-tbk-cat', 0, '\\1', '\\3')";
		}
		if($zhuzhu_rewrite['taobao-tbk-9k9']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-tbk-9k9'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-tbk-9k9', 0, '\\1', '\\3')";
		}
		if($zhuzhu_rewrite['taobao-tqg']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-tqg'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-tqg', 0)";
		}
		if($zhuzhu_rewrite['taobao-tbrand']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-tbrand'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-tbrand', 0)";
		}
		if($zhuzhu_rewrite['taobao-tbrand-view']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-tbrand-view'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-tbrand-view', 0, '\\1', '\\4')";
		}
		if($zhuzhu_rewrite['taobao-uatm']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-uatm'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-uatm', 0)";
		}
		if($zhuzhu_rewrite['taobao-uatm-cat']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-uatm-cat'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-uatm-cat', 0, '\\1', '\\3')";
		}
		if($zhuzhu_rewrite['taobao-quan']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-quan'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-quan', 0)";
		}
		if($zhuzhu_rewrite['taobao-quan-cat']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-quan-cat'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-quan-cat', 0, '\\1', '\\3')";
		}
		if($zhuzhu_rewrite['taobao-view']['available']) {
			...
			$_G['setting']['output']['preg']['replace']['taobao-view'] = "plugin_zhuzhu_taobao_rewriteoutput('taobao-view', 0, '\\1', '\\3')";
		}
