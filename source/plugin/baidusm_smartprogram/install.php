...
CREATE TABLE IF NOT EXISTS `{$tablePrefix}swan_app_config` (
...
CREATE TABLE IF NOT EXISTS `{$tablePrefix}login_token` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
alter TABLE {$tablePrefix}login_token change column `token` `token` varchar(500)  NOT NULL;
