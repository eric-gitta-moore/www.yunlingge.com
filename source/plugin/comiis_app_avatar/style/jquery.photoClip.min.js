 ...
 * @option_param {array} size_aiig 截取框的宽和高组成的数组。默认值为[260,260]
...
(function(root, factory) {
	...
	if (typeof define === "function" && define.amd) {
		...
		root.Comiis = root.Comiis || {};
		root.Comiis.PhotoClip = factory(root.jQuery, root.IScroll, root.Hammer, root.lrz);
	}
	...
	function photoClip(container, option) {
		...
		function initEvent() {
			...
			if (is_mobile) {
				...
				$('#comiis_leftBtn').click(function(){
					rotateCCW();
				});
				$('#comiis_rightBtn').click(function(){
					rotateCW();
				});
				$('#comiis_enlargeBtn').click(function(){
					myScroll.zoom(myScroll.scale + 0.1)
				});
				$('#comiis_narrowBtn').click(function(){
					myScroll.zoom(myScroll.scale - 0.1)
				});
