...
showsubtitle(array('',$_lang['order_id'],$_lang['order_api'],$_lang['order_price'],$_lang['order_username'],$_lang['order_dateline'],$_lang['order_finishdateline'],$_lang['order_payorderid'],$_lang['order_status']));
foreach($vus as $v){
