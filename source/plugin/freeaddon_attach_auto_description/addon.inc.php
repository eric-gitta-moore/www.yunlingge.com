 ...
 * $Id: addon.inc.php 906 2019-11-26 13:03:55Z zhuge $
...
require_once DISCUZ_ROOT.'./source/discuz_version.php';/*7437*/
...
$param .= '&md5hash='.substr(md5($data.TIMESTAMP), 8, 8).'&timestamp='.TIMESTAMP;/*版权：1314学习网，未经允许不得公开出售、发布、使用、修改，如需购买请联系我们获得授权*/
s_addon_stat($plugin,'addon');

//Copyright 2001-2099 1314学习网.
//This is NOT a freeware, use is subject to license terms
//$Id: addon.inc.php 1350 2019-11-26 05:03:55Z zhuge $
//应用售后问题：http://www.1314study.com/services.php?mod=issue
//应用售前咨询：QQ 15326940
//应用定制开发：QQ 643306797
//本插件为 1314学习网（www.1314study.com） 独立开发的原创插件, 依法拥有版权。
