...
class mobileplugin_jzsjiale_seo_alt
{
...
class mobileplugin_jzsjiale_seo_alt_forum extends mobileplugin_jzsjiale_seo_alt
{
            ...
            if ($curm == "viewthread") {
                ...
                */
                ...
                foreach($altsettings as $key => $value) {
                    ...
                    if (in_array('3',json_decode($value['targets'])) && (!empty($fid)?in_array($fid,json_decode($value['fids'])):false) && $value ['isopen'] == '1' && in_array ( $groupid, json_decode ( $value ['usergroup'] ) ))
                    {
                        $isok = true;
