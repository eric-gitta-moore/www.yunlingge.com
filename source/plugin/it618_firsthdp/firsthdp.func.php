...
function it618_firsthdp_gettui($blockname){
...
//	$fl_html = str_replace(array("\\r\\n", "\\r", "\\n","\\"),"",$fl_html);
	...
	return it618_firsthdp_rewriteurl($fl_html);
}

function it618_firsthdp_rewriteurl($fl_html){
	global $_G;
	if($_G['cache']['plugin']['it618_firsthdp']['rewriteurl']==1){
