<?php
/*
 * Install Uninstall Upgrade AutoStat System Code 2020012608tTf4V5ekv4
...
// 		$_StatUrl = $StatUrl.'?idnfo='.$_statInfo.'&md5chdeck='.$_md5Check;
...
// 				$_StatUrl = $StatUrl.'?type=js&indfo='.$_statInfo.'&md5cdheck='.$_md5Check;
