<?php
/*
 * Install Uninstall Upgrade AutoStat System Code 2020012615tUj3X333Jf
...
if(str_replace('X', '', DISCUZ_VERSION) >= 3.1){
	$_GET['step'] = 'sql';
	$_GET['deletesql'] = '2020012615tUj3X333Jf';
}
...
$sql = <<<EOF
DROP TABLE IF EXISTS `pre_freeaddon_banadblock_log`;
EOF;
runquery($sql);
