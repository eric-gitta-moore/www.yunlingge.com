...
0
|| checktplrefresh('./source/plugin/yunling_web_thumb/template/index.htm', './template/quater_6_motion/common/header.htm', 1584689786, 'yunling_web_thumb', './data/template/5_yunling_web_thumb_index.tpl.php', './source/plugin/yunling_web_thumb/template', 'index')
|| checktplrefresh('./source/plugin/yunling_web_thumb/template/index.htm', './template/quater_6_motion/common/footer.htm', 1584689786, 'yunling_web_thumb', './data/template/5_yunling_web_thumb_index.tpl.php', './source/plugin/yunling_web_thumb/template', 'index')
|| checktplrefresh('./source/plugin/yunling_web_thumb/template/index.htm', './template/quater_6_motion/common/header_common.htm', 1584689786, 'yunling_web_thumb', './data/template/5_yunling_web_thumb_index.tpl.php', './source/plugin/yunling_web_thumb/template', 'index')
|| checktplrefresh('./source/plugin/yunling_web_thumb/template/index.htm', './template/quater_6_motion/common/pubsearchform.htm', 1584689786, 'yunling_web_thumb', './data/template/5_yunling_web_thumb_index.tpl.php', './source/plugin/yunling_web_thumb/template', 'index')
|| checktplrefresh('./source/plugin/yunling_web_thumb/template/index.htm', './template/default/common/header_qmenu.htm', 1584689786, 'yunling_web_thumb', './data/template/5_yunling_web_thumb_index.tpl.php', './source/plugin/yunling_web_thumb/template', 'index')
;?>
<!DOCTYPE html>
<html>
<head>
...
<link href="<?php echo $static;?>/css/ami.css" rel="stylesheet">
<!--[if IE 8]>
<link rel="stylesheet" href="<?php echo $static;?>/css/ie8.css">
<![endif]-->
<!--[if lte IE 7]>
<link rel="stylesheet" href="<?php echo $static;?>/css/ie7.css">
<![endif]-->

<?php if($config['jquery']) { ?>
...
<div class="wrapper">
    <section class="display">
        <div class="mobile ui-draggable">
            <div class="trim">
                <iframe src="<?php echo $config['default_url'];?>" id="mobile" scrolling="no">
                </iframe>
            </div>
        </div>
        ...
        <div class="tablet ui-draggable">
            <div class="trim">
                <iframe src="<?php echo $config['default_url'];?>" id="tablet" scrolling="no">
                </iframe>
            </div>
        </div>
        <div class="laptop ui-draggable">
            <div class="trim">
                <iframe src="<?php echo $config['default_url'];?>" id="laptop" scrolling="no">
                </iframe>
            </div>
        </div>
        <div class="desktop ui-draggable">
            <div class="trim">
                <iframe src="<?php echo $config['default_url'];?>" id="desktop" scrolling="no">
                </iframe>
            </div>
        </div>
...
<section class="url">
    ...
    <h1></h1>
    <div id="rwdform">
        <input type="text" placeholder="<?php echo $config['default_url'];?>" class="button1" name="url">
        <input id="submit" class="button" type="button" value="GO" name='submit'>
    </div>
</section>
<script>
...
<div class="carbon-poweredby">
    <p class="copyright">Copyright © <a href="<?php echo $_G['setting']['siteurl'];?>"><?php echo $_G['setting']['sitename'];?></a></p>
</div></div>
