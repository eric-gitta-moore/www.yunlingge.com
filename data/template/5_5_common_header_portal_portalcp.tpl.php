...
0
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/header_common.htm', 1584689570, '5', './data/template/5_5_common_header_portal_portalcp.tpl.php', './template/quater_6_motion', 'common/header_portal_portalcp')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/pubsearchform.htm', 1584689570, '5', './data/template/5_5_common_header_portal_portalcp.tpl.php', './template/quater_6_motion', 'common/header_portal_portalcp')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/default/common/header_qmenu.htm', 1584689570, '5', './data/template/5_5_common_header_portal_portalcp.tpl.php', './template/quater_6_motion', 'common/header_portal_portalcp')
;?>
<!DOCTYPE html>
<html>
<head>
