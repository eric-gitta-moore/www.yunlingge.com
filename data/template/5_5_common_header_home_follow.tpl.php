...
0
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/header_common.htm', 1584698465, '5', './data/template/5_5_common_header_home_follow.tpl.php', './template/quater_6_motion', 'common/header_home_follow')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/pubsearchform.htm', 1584698465, '5', './data/template/5_5_common_header_home_follow.tpl.php', './template/quater_6_motion', 'common/header_home_follow')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/default/common/header_qmenu.htm', 1584698465, '5', './data/template/5_5_common_header_home_follow.tpl.php', './template/quater_6_motion', 'common/header_home_follow')
;?>
<!DOCTYPE html>
<html>
<head>
