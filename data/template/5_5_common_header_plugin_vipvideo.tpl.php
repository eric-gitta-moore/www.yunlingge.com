...
0
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/header_common.htm', 1584689170, '5', './data/template/5_5_common_header_plugin_vipvideo.tpl.php', './template/quater_6_motion', 'common/header_plugin_vipvideo')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/pubsearchform.htm', 1584689170, '5', './data/template/5_5_common_header_plugin_vipvideo.tpl.php', './template/quater_6_motion', 'common/header_plugin_vipvideo')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/default/common/header_qmenu.htm', 1584689170, '5', './data/template/5_5_common_header_plugin_vipvideo.tpl.php', './template/quater_6_motion', 'common/header_plugin_vipvideo')
;?>
<!DOCTYPE html>
<html>
<head>
