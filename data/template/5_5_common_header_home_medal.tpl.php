...
0
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/header_common.htm', 1584713432, '5', './data/template/5_5_common_header_home_medal.tpl.php', './template/quater_6_motion', 'common/header_home_medal')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/pubsearchform.htm', 1584713432, '5', './data/template/5_5_common_header_home_medal.tpl.php', './template/quater_6_motion', 'common/header_home_medal')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/default/common/header_qmenu.htm', 1584713432, '5', './data/template/5_5_common_header_home_medal.tpl.php', './template/quater_6_motion', 'common/header_home_medal')
;?>
<!DOCTYPE html>
<html>
<head>
