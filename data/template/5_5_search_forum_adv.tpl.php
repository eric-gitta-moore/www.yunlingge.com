...
0
|| checktplrefresh('./template/quater_6_motion/search/forum_adv.htm', './template/quater_6_motion/search/pubsearch.htm', 1584699858, '5', './data/template/5_5_search_forum_adv.tpl.php', './template/quater_6_motion', 'search/forum_adv')
...
</div><?php include template('search/footer'); ?><?php if(function_exists('yunling_redirect_resource_output')){yunling_redirect_resource_output('doNotMove');}?>