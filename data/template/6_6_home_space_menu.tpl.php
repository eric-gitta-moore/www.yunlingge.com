...
0
|| checktplrefresh('./template/default/home/space_menu.htm', './template/default/home/follow_user_header.htm', 1584733802, '6', './data/template/6_6_home_space_menu.tpl.php', './template/comiis_app', 'home/space_menu')
;?>
<?php if($space['uid']) { ?>
<div id="uhd">
...
<li class="pm2">
<a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $space['uid'];?>&amp;touid=<?php echo $space['uid'];?>&amp;pmid=0&amp;daterange=2" id="a_sendpm_<?php echo $space['uid'];?>" onclick="showWindow('showMsgBox', this.href, 'get', 0)" title="发消息">发消息</a>
</li>
</ul>
<?php if(helper_access::check_module('follow')) { ?>
