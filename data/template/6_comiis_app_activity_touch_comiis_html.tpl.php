...
0
|| checktplrefresh('./source/plugin/comiis_app_activity/template/touch/comiis_html.htm', './template/comiis_app/touch/common/header.htm', 1584837843, 'comiis_app_activity', './data/template/6_comiis_app_activity_touch_comiis_html.tpl.php', './source/plugin/comiis_app_activity/template', 'touch/comiis_html')
|| checktplrefresh('./source/plugin/comiis_app_activity/template/touch/comiis_html.htm', './template/comiis_app/touch/common/footer.htm', 1584837843, 'comiis_app_activity', './data/template/6_comiis_app_activity_touch_comiis_html.tpl.php', './source/plugin/comiis_app_activity/template', 'touch/comiis_html')
;?>
...
</script><?php comiis_load('XxKPUdUoOuXFOfpPVy', '');?><link rel="stylesheet" href="source/plugin/comiis_app_activity/style/comiis.css" type="text/css" media="all">
<?php if($comiis_app_activity_set['css']) { ?>
<style><?php echo strip_tags($comiis_app_activity_set['css']);; ?></style>
<?php } if($comiis_app_activity_set['open_header']) { ?>
<header class="comiis_achead zrnb cl">
<div class="head_l"><a href="javascript:history.back(-1)"><img src="source/plugin/comiis_app_activity/style/comiis_top_lico.png"></a></div>
<h2><?php echo $comiis_app_activity_set['name'];?></h2>
<div class="head_r">
<?php if($comiis_app_activity_set['post_url']) { ?>
<a href="<?php echo $comiis_app_activity_set['post_url'];?>"><img src="source/plugin/comiis_app_activity/style/comiis_top_fhd.png"></a>
<?php } else { ?>
<a href="/"><img src="source/plugin/comiis_app_activity/style/comiis_top_rico.png"></a>
<?php } ?>
</div>
</header>
<?php } if($comiis_app_activity_set['header_ad']) { ?><div class="comiis_ac_ggbig cl"><?php echo $comiis_app_activity_set['header_ad'];?></div><?php } ?>
<div class="comiis_acheader pyti acbg_f bg_f cl">
<div id="comiis_actop_box" class="acb_b b_b">
<div class="comiis_actop_ico_box">
<div class="comiis_actop_ico_l"></div>
<div class="comiis_actop_ico acbg_f acb_l bg_f b_l">
<img src="source/plugin/comiis_app_activity/style/comiis_actop_ico.png">
</div>
</div>
<div id="comiis_actop_nvgksk">
<ul class="swiper-wrapper">
<li class="swiper-slide<?php if(empty($comiis_app_activityclass)) { ?> actop_nvon<?php } ?>"><a href="plugin.php?id=comiis_app_activity" class="<?php if(empty($comiis_app_activityclass)) { ?>acb_0 acf_0 b_0 f_0<?php } else { ?>acb_d acf_c b_d f_c<?php } ?>"><?php echo $comiis_app_ac_lang['01'];?></a></li><?php if(is_array($activitytypelist)) foreach($activitytypelist as $temp) { ?><li class="swiper-slide<?php if($comiis_app_activityclass == $temp) { ?> actop_nvon<?php } ?>"><a href="plugin.php?id=comiis_app_activity&amp;class=<?php echo urlencode($temp);; if($comiis_app_activitytype) { ?>&amp;type=<?php echo $comiis_app_activitytype;?><?php } ?>" class="<?php if($comiis_app_activityclass == $temp) { ?>acb_0 acf_0 b_0 f_0<?php } else { ?>acb_d acf_c b_d f_c<?php } ?>"><?php echo $temp;?></a></li>
<?php } ?>
<li class="swiper-slide" style="width:45px;"></li>
</ul>
</div>
</div>
</div>
<div class="comiis_ac_my fqvp acbg_f acb_b bg_f b_b"<?php if(!$comiis_app_activitytype) { ?> style="display:none;"<?php } ?>>
<ul>
<li class="acb_l b_l"><a href="plugin.php?id=comiis_app_activity<?php if($comiis_app_activityclass) { ?>&amp;class=<?php echo urlencode($comiis_app_activityclass);; } ?>&amp;type=start" class="<?php if($comiis_app_activitytype == 'start') { ?>acf_0 f_0<?php } else { ?>acf_d f_d<?php } ?>"><?php echo $comiis_app_ac_lang['02'];?></a></li>
<li class="acb_l b_l"><a href="plugin.php?id=comiis_app_activity<?php if($comiis_app_activityclass) { ?>&amp;class=<?php echo urlencode($comiis_app_activityclass);; } ?>&amp;type=end" class="<?php if($comiis_app_activitytype == 'end') { ?>acf_0 f_0<?php } else { ?>acf_d f_d<?php } ?>"><?php echo $comiis_app_ac_lang['03'];?></a></li>
<li class="acb_l b_l"><a <?php if($_G['uid']) { ?>href="plugin.php?id=comiis_app_activity<?php if($comiis_app_activityclass) { ?>&amp;class=<?php echo urlencode($comiis_app_activityclass);; } ?>&amp;type=participate"<?php } else { ?>href="javascript:;" onclick="popup.open('<?php echo $comiis_app_ac_lang['06'];?>', 'confirm', 'member.php?mod=logging&action=login');"<?php } ?> class="<?php if($comiis_app_activitytype == 'participate') { ?>acf_0 f_0<?php } else { ?>acf_d f_d<?php } ?>"><?php echo $comiis_app_ac_lang['04'];?></a></li>
<li class="acb_l b_l"><a <?php if($_G['uid']) { ?>href="plugin.php?id=comiis_app_activity<?php if($comiis_app_activityclass) { ?>&amp;class=<?php echo urlencode($comiis_app_activityclass);; } ?>&amp;type=launched"<?php } else { ?>href="javascript:;" onclick="popup.open('<?php echo $comiis_app_ac_lang['06'];?>', 'confirm', 'member.php?mod=logging&action=login');"<?php } ?> class="<?php if($comiis_app_activitytype == 'launched') { ?>acf_0 f_0<?php } else { ?>acf_d f_d<?php } ?>"><?php echo $comiis_app_ac_lang['05'];?></a></li>
</ul>
</div>
<div class="comiis_ach10 bg_e b_b"></div>
<?php if(count($comiis_app_activity)) { ?>
<div class="comiis_activity acbg_f bg_f cl">
<ul><?php if(is_array($comiis_app_activity)) foreach($comiis_app_activity as $key => $temp) { ?><li class="acb_t b_t">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $temp['tid'];?>">
<div class="act_tit"><?php echo $temp['subject'];?></div>
<div class="act_time acf_a f_a"><span class="acbg_a bg_a f_f"><?php echo $temp['class'];?></span><?php echo $comiis_app_ac_lang['07'];?>: <?php echo dgmdate($temp['starttimefrom'], 'u', '9999', 'Y-m-d');; if($temp['starttimeto']) { ?> - <?php echo dgmdate($temp['starttimeto'], 'u', '9999', 'Y-m-d');; } ?></div>
<?php if($temp['aid']) { ?>
<div class="act_img"><img src="<?php echo getforumimg($temp['aid'], '0', '640', '9999'); ?>" class="vm"></div>
<?php } else { ?>
<div class="act_noimg acbg_b bg_b f_c"><?php echo $comiis_app_ac_lang['08'];?></div>
<?php } ?>
<div class="act_btn acf_c f_c"><?php echo $temp['starttimeto'] > 0 ? ($temp['starttimeto'] > TIMESTAMP ? '<em class="acbg_a bg_a f_f">'.$comiis_app_ac_lang['09'].'</em>' : '<em class="acbg_b bg_b f_c">'.$comiis_app_ac_lang['10'].'</em>') : ($temp['starttimefrom'] > TIMESTAMP ? '<em class="acbg_a bg_a f_f">'.$comiis_app_ac_lang['09'].'</em>' : '<em class="acbg_b bg_b f_c">'.$comiis_app_ac_lang['10'].'</em>');; ?> <?php echo $comiis_app_ac_lang['11'];?><span class="acf_a f_a"><?php echo $temp['views'];?></span><?php echo $comiis_app_ac_lang['12'];?></div>
</a>
</li>
<?php if(is_array($list_ad[$startlimit+$key+1])) { if(is_array($list_ad[$startlimit+$key+1])) foreach($list_ad[$startlimit+$key+1] as $ad_temp) { ?><div class="comiis_ac_ggbig comiis_ac_gg acb_t b_t cl">
<a href="<?php echo $ad_temp['2'];?>"><em><?php echo $ad_temp['1'];?></em><img src="<?php echo $ad_temp['3'];?>" width="100%"></a>
</div>
<?php } } } ?>
</ul>
</div>
<?php echo $multipage;?>
<?php } else { ?>
<div class="comiis_ac_nodata acbg_f acf_d bg_f f_d cl">
<img src="source/plugin/comiis_app_activity/style/comiis_nodata.png" class="vm">
<h2><?php echo $comiis_app_activity_set['no_ac'];?></h2>		
</div>
<?php } ?>
<script src="./source/plugin/comiis_app_activity/style/comiis_swiper.min.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<script>
if($("#comiis_actop_nvgksk li.actop_nvon").length > 0) {
var comiis_indexhqsy = $("#comiis_actop_nvgksk li.actop_nvon").offset().left + $("#comiis_actop_nvgksk li.actop_nvon").width() >= $(window).width() ? $("#comiis_actop_nvgksk li.actop_nvon").index() : 0;
}else{
var comiis_indexhqsy = 0;
}
new Swiper('#comiis_actop_nvgksk', {
freeMode : true,
slidesPerView : 'auto',
initialSlide : comiis_indexhqsy,
...
$('.comiis_actop_ico').on('click', function(e) {
$(this).toggleClass('comiis_actop_ico_on');
$('.comiis_ac_my').toggle();
});
</script><?php $comiis_foot = 'no';?><?php if(!empty($_G['setting']['pluginhooks']['global_footer_mobile'])) echo $_G['setting']['pluginhooks']['global_footer_mobile'];?><?php comiis_load('j9alEz9X55JrjbA3l9', '');?><div id="mask" style="display:none;"></div>
