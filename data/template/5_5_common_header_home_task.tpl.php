...
0
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/header_common.htm', 1584748846, '5', './data/template/5_5_common_header_home_task.tpl.php', './template/quater_6_motion', 'common/header_home_task')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/pubsearchform.htm', 1584748846, '5', './data/template/5_5_common_header_home_task.tpl.php', './template/quater_6_motion', 'common/header_home_task')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/default/common/header_qmenu.htm', 1584748846, '5', './data/template/5_5_common_header_home_task.tpl.php', './template/quater_6_motion', 'common/header_home_task')
;?>
<!DOCTYPE html>
<html>
<head>
