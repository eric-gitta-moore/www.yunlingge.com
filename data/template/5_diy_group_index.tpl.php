...
block_get('34,36,35');?><?php include template('common/header'); ?><link rel="stylesheet" type="text/css" href='/template/quater_6_motion/group/group.css' />
...
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a>
          ...
          <em>&raquo;</em><a href="group.php"><?php echo $_G['setting']['navs']['3']['navname'];?></a><?php echo $navigation;?>
</div>
...
<div class="bm bmw">
<!--[diy=diy5]--><div id="diy5" class="area"><div id="frameMaJaja" class="frame move-span cl frame-1"><div id="frameMaJaja_left" class="column frame-1-c"><div id="frameMaJaja_left_temp" class="move-span temp"></div><?php block_display('34');?></div></div></div><!--[/diy]-->
</div>
<!--[diy=diycommendtop]--><div id="diycommendtop" class="area"><div id="frameB9aHJj" class="frame move-span cl frame-1"><div id="frameB9aHJj_left" class="column frame-1-c"><div id="frameB9aHJj_left_temp" class="move-span temp"></div><?php block_display('36');?></div></div></div><!--[/diy]-->
...
<div class="bm">
   ...
   <!--[diy=diysidemiddle]--><div id="diysidemiddle" class="area"><div id="framejMHTXM" class="frame move-span cl frame-1"><div id="framejMHTXM_left" class="column frame-1-c"><div id="framejMHTXM_left_temp" class="move-span temp"></div><?php block_display('35');?></div></div></div><!--[/diy]-->
</div>
<div class="drag">
