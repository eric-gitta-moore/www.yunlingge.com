...
0
|| checktplrefresh('./template/default/mobile/forum/discuz.htm', './template/default/mobile/common/header.htm', 1584693998, 'diy', './data/template/1_diy_mobile_forum_discuz.tpl.php', './template/default', 'mobile/forum/discuz')
|| checktplrefresh('./template/default/mobile/forum/discuz.htm', './template/default/mobile/common/footer.htm', 1584693998, 'diy', './data/template/1_diy_mobile_forum_discuz.tpl.php', './template/default', 'mobile/forum/discuz')
;?>
...
</html><?php updatesession();?><?php if(defined('IN_MOBILE')) { if(function_exists('yunling_redirect_resource_output')){yunling_redirect_resource_output();}?><?php } else { if(function_exists('yunling_redirect_resource_output')){yunling_redirect_resource_output('preview');}?><?php } ?>
