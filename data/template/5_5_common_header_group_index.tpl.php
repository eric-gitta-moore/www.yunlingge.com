...
0
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/header_common.htm', 1584843796, '5', './data/template/5_5_common_header_group_index.tpl.php', './template/quater_6_motion', 'common/header_group_index')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/pubsearchform.htm', 1584843796, '5', './data/template/5_5_common_header_group_index.tpl.php', './template/quater_6_motion', 'common/header_group_index')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/default/common/header_qmenu.htm', 1584843796, '5', './data/template/5_5_common_header_group_index.tpl.php', './template/quater_6_motion', 'common/header_group_index')
;?>
<!DOCTYPE html>
<html>
<head>
