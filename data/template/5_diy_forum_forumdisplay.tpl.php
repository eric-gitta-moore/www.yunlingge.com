...
0
|| checktplrefresh('data/diy/./template/quater_6_motion//forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1584689769, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/quater_6_motion/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/quater_6_motion//forum/forumdisplay.htm', './template/quater_6_motion/forum/recommend.htm', 1584689769, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/quater_6_motion/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/quater_6_motion//forum/forumdisplay.htm', './template/quater_6_motion/common/seccheck.htm', 1584689769, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/quater_6_motion/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/quater_6_motion//forum/forumdisplay.htm', './template/quater_6_motion/forum/forumdisplay_list.htm', 1584689769, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/quater_6_motion/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/quater_6_motion//forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1584689769, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/quater_6_motion/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/quater_6_motion//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1584689769, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/quater_6_motion/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/quater_6_motion//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1584689769, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/quater_6_motion/', 'forum/forumdisplay')
;
block_get('81');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
...
<em>&raquo;</em><a href="forum.php"><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?>
</div>
...
<div class="cl">
                   <div class="forumlist_tit" style="padding: 0 0 15px 0; margin: 10px 0 10px 0; border-bottom: 1px solid #F0F0F0;">
                      <h2 style="padding: 0 0 13px 0; border-bottom: 4px solid #1a87f3;"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"><?php echo $_G['forum']['name'];?></a></h2>
                      <span class="management z" style="margin: 2px 0 0 20px;">
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum&amp;formhash=<?php echo FORMHASH;?>" data-no-instant id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);">收藏本版 <em class="xi1" id="number_favorite" <?php if(!$_G['forum']['favtimes']) { ?> style="display:none;"<?php } ?>>(<span id="number_favorite_num"><?php echo $_G['forum']['favtimes'];?></span>)</em></a>
...
<span class="pipe"></span><a href="<?php if($_G['adminid'] == 1) { ?>admin.php?mod=forum&action=recyclebin&frames=yes<?php } elseif($_G['forum']['ismoderator']) { ?>forum.php?mod=modcp&action=recyclebin&fid=<?php echo $_G['fid'];?><?php } ?>" target="_blank">回收站</a>
...
<?php } if($moderatedby) { ?><div>版主: <em><?php echo $moderatedby;?></em></div><?php } if($_G['page'] == 1 && $_G['forum']['rules']) { ?>
...
<?php } ?>
            ...
            <div style="margin-bottom: 20px; font-size: 16px;" class="annoucement"><?php if(empty($announcement['type'])) { ?><a href="forum.php?mod=announcement&amp;id=<?php echo $announcement['id'];?>#<?php echo $announcement['id'];?>" target="_blank">公告：<?php echo $announcement['subject'];?></a><?php } else { ?><a href="<?php echo $announcement['message'];?>" target="_blank">公告：<?php echo $announcement['subject'];?></a><?php } ?></div>
            <?php } ?>
...
<?php } ?>
<div class="recommend cl"<?php if($_G['forum']['recommendlist']['images'] && $_G['forum']['modrecommend']['imagenum']) { ?> style="margin-left: <?php echo $_G['forum']['modrecommend']['imagewidth'];?>px; padding-left: 20px;"<?php } ?>><?php unset($_G['forum']['recommendlist']['images']);?><ul class="xl<?php if(!$_G['forum']['allowside']) { ?> xl2<?php } ?> cl"><?php if(is_array($_G['forum']['recommendlist'])) foreach($_G['forum']['recommendlist'] as $rtid => $recommend) { ?><li class="f14">
...
<div class="bm bmw fl<?php if($_G['forum']['forumcolumns']) { ?> flg<?php } ?>" style="margin-bottom: 15px;">
<div class="bm_h cl" style="padding: 0 0 5px 0; margin-bottom: 5px; border-top: 0;">
...
<h2 style="font-size: 16px;">推荐<?php echo $_G['setting']['navs']['3']['navname'];?></h2>
</div>
<div class="cl" id="recommendgroups_<?php echo $_G['forum']['fid'];?>" style="padding: 12px; background: #F9F9F9; <?php echo $collapse['recommendgroups'];?>">
...
<tr>
<th colspan="<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>3<?php } else { ?>2<?php } ?>" style="border-top: 0;">
<?php if(CURMODULE != 'guide') { ?>
<div class="tf">
<span id="atarget" <?php if($_G['cookie']['atarget'] > 0) { ?>onclick="setatarget(-1)" class="y atarget_1"<?php } else { ?>onclick="setatarget(1)" class="y"<?php } ?> title="在新窗口中打开帖子" style="margin-top: 1px;">新窗</span>
...
<?php if($_G['forum']['ismoderator'] && !$_GET['archiveid']) { ?><td class="o" style="border-top: 0;"></td><?php } ?>
...
<tr>
<td class="icn">
<a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" target="_blank" class="avt_x"><?php echo avatar($thread[authorid],small);?></a>
</td>
...
<?php } ?>
<th class="<?php echo $thread['folder'];?> thread_tit">
...
<img src="/template/quater_6_motion/src/quater_forum/hot_<?php echo $thread['heatlevel'];?>.gif" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
...
<img src="/template/quater_6_motion/src/quater_forum/folder_lock.gif" />
<?php } elseif($thread['special'] == 1) { ?>
<img src="/template/quater_6_motion/src/quater_forum/pollsmall.gif" alt="投票" />
<?php } elseif($thread['special'] == 2) { ?>
<img src="/template/quater_6_motion/src/quater_forum/tradesmall.gif" alt="商品" />
<?php } elseif($thread['special'] == 3) { ?>
<img src="/template/quater_6_motion/src/quater_forum/rewardsmall.gif" alt="悬赏" />
<?php } elseif($thread['special'] == 4) { ?>
<img src="/template/quater_6_motion/src/quater_forum/activitysmall.gif" alt="活动" />
<?php } elseif($thread['special'] == 5) { ?>
<img src="/template/quater_6_motion/src/quater_forum/debatesmall.gif" alt="辩论" />
<?php } elseif(in_array($thread['displayorder'], array(1, 2, 3, 4))) { ?>
<img src="/template/quater_6_motion/src/quater_forum/pin_<?php echo $thread['displayorder'];?>.gif" alt="<?php echo $_G['setting']['threadsticky'][3-$thread['displayorder']];?>" />
<?php } ?>
</a>
...
<?php } } ?>
                                        ...
                                        <div class="emt_box">
                                          <?php if(!empty($_G['setting']['pluginhooks']['time_summary'][$key])) echo $_G['setting']['pluginhooks']['time_summary'][$key];?>
                                        </div>
                                        ...
                                        <a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>">
                                      <span style="margin-left: 0;">作者：<?php echo $thread['author'];?></span></a><span style="margin-left: 20px;"> <?php echo $thread['dateline'];?></span>
</i>

                                        
                                        <i class="y">
                                           <span><?php if($thread['lastposter']) { ?><a href="<?php if($thread['digest'] != -2) { ?>home.php?mod=space&username=<?php echo $thread['lastposterenc'];?><?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?>&page=<?php echo max(1, $thread['pages']);; } ?>" c="1"><?php echo $thread['lastposter'];?></a><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?><?php } ?></span>
...
<ul id="waterfall" class="ml waterfall cl" style="margin-top: 0;"><?php if(is_array($_G['forum_threadlist'])) foreach($_G['forum_threadlist'] as $key => $thread) { if($_G['hiddenexists'] && $thread['hidden']) { continue;?><?php } if(!$thread['forumstick'] && ($thread['isgroup'] == 1 || $thread['fid'] != $_G['fid'])) { if($thread['related_group'] == 0 && $thread['closed'] > 1) { $thread[tid]=$thread[closed];?><?php } } $waterfallwidth = $_G[setting][forumpicstyle][thumbwidth] + 24;?><li style="width:<?php echo $waterfallwidth;?>px">
<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>
...
<ul>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=lastpost&amp;orderby=lastpost<?php echo $forumdisplayadd['lastpost'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'lastpost') { ?> xw1<?php } ?>">最新</a></li>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=heat&amp;orderby=heats<?php echo $forumdisplayadd['heat'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'heat') { ?> xw1<?php } ?>">热门</a></li>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=hot" class="xi2<?php if($_GET['filter'] == 'hot') { ?> xw1<?php } ?>">热帖</a></li>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=digest&amp;digest=1<?php echo $forumdisplayadd['digest'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'digest') { ?> xw1<?php } ?>">精华</a></li>
</ul>
</div>
...
<a class="bm_h" href="javascript:;" rel="<?php echo $multipage_more;?>" curpage="<?php echo $page;?>" id="autopbn" totalpage="<?php echo $maxpage;?>" picstyle="<?php echo $_G['forum']['picstyle'];?>" forumdefstyle="<?php echo $_G['cookie']['forumdefstyle'];?>">点击加载更多</a>
...
<!--备份2020-02-28 instant.page改造-->
<!--<a id="newspecialtmp" onClick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发布新帖" style="margin: -8px 0 0 0;">发布新帖</a>-->
<a id="newspecialtmp" href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>" title="发布新帖" style="margin: -8px 0 0 0;">发布新帖</a>
<?php } ?>
...
<ul class="cl" style="width: 310px;"><?php if(is_array($_G['cache']['forums'])) foreach($_G['cache']['forums'] as $bforum) { if($bforum['fup'] == $_G['forum']['fup'] && $bforum['status']) { ?>
...
<?php } ?>
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameShBldD" class="frame move-span cl frame-1"><div id="frameShBldD_left" class="column frame-1-c"><div id="frameShBldD_left_temp" class="move-span temp"></div><?php block_display('81');?></div></div></div><!--[/diy]-->
</div>
...
<?php if(empty($_G['setting']['disfixednv_forumdisplay']) ) { ?><script>fixed_top_nv();</script><?php } include template('common/footer'); ?><?php if(function_exists('yunling_redirect_resource_output')){yunling_redirect_resource_output('doNotMove');}?>