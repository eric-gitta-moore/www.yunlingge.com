...
<script>
{$comiis_lookfulltext['jquery_id']}(window).ready(function(){
var comiis_lookfulltext_box = {$comiis_lookfulltext['jquery_id']}('#postlist .pcb:first,#ct div.d{$comiis_lookfulltext['pc_class']}');
var comiis_lookfulltext_height = comiis_lookfulltext_box.height();
if(comiis_lookfulltext_height > {$comiis_lookfulltext['pc_maxheight']}){
...
'max-height':'{$comiis_lookfulltext['pc_maxheight']}px',
'overflow-y':'hidden',
'position':'relative'
}).append('<div class="comiis_lookfulltext_bg"></div>');
{$comiis_lookfulltext['jquery_id']}(document).on('click', '.comiis_lookfulltext_key', function(e) {
{$comiis_lookfulltext['jquery_id']}('.comiis_lookfulltext_key,.comiis_lookfulltext_bg').remove();
