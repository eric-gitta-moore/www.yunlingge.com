...
0
|| checktplrefresh('./template/default/home/space_profile.htm', './template/default/home/space_header.htm', 1584698328, '5', './data/template/5_5_home_space_profile.tpl.php', './template/quater_6_motion', 'home/space_profile')
|| checktplrefresh('./template/default/home/space_profile.htm', './template/quater_6_motion/home/space_profile_body.htm', 1584698328, '5', './data/template/5_5_home_space_profile.tpl.php', './template/quater_6_motion', 'home/space_profile')
|| checktplrefresh('./template/default/home/space_profile.htm', './template/default/home/space_userabout.htm', 1584698328, '5', './data/template/5_5_home_space_profile.tpl.php', './template/quater_6_motion', 'home/space_profile')
|| checktplrefresh('./template/default/home/space_profile.htm', './template/quater_6_motion/common/header_common.htm', 1584698328, '5', './data/template/5_5_home_space_profile.tpl.php', './template/quater_6_motion', 'home/space_profile')
|| checktplrefresh('./template/default/home/space_profile.htm', './template/default/home/space_diy.htm', 1584698328, '5', './data/template/5_5_home_space_profile.tpl.php', './template/quater_6_motion', 'home/space_profile')
|| checktplrefresh('./template/default/home/space_profile.htm', './template/default/home/space_header_personalnv.htm', 1584698328, '5', './data/template/5_5_home_space_profile.tpl.php', './template/quater_6_motion', 'home/space_profile')
;?>
<?php if($_G['setting']['homepagestyle']) { $_G[cookie][extstyle] = false;?><!DOCTYPE html>
<html>
<head>
...
<div class="bm bw0">
<div class="bm_c">
<?php } ?><div class="u_profile" style="padding: 20px 10px; font-size: 14px; background: #FFFFFF;">
...
<span class="pipe" style="margin: 0 15px;">|</span><?php $space['posts'] = $space['posts'] - $space['threads'];?><a href="<?php if(CURMODULE != 'follow') { ?>home.php?mod=space&uid=<?php echo $space['uid'];?>&do=thread&view=me&type=reply&from=space<?php } else { ?>home.php?mod=space&uid=<?php echo $space['uid'];?>&view=thread&type=reply<?php } ?>" target="_blank">回帖数 <?php echo $space['posts'];?></a>
<span class="pipe" style="margin: 0 15px;">|</span>
...
<?php if($space['buyercredit']) { ?>
        <span class="pipe" style="margin: 0 15px;">|</span>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=trade&amp;view=eccredit#sellcredit" target="_blank">卖家信用 <?php echo $space['buyercredit'];?></a>
<?php } if($space['sellercredit']) { ?>
        <span class="pipe" style="margin: 0 15px;">|</span>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=trade&amp;view=eccredit#buyercredit" target="_blank">买家信用 <?php echo $space['sellercredit'];?></a>
<?php } ?>
        <span class="pipe" style="margin: 0 15px;">|</span>
<a>积分 <?php echo $space['credits'];?></a>
...
<?php } ?>
            ...
            <?php if($_G['setting']['verify']['enabled']) { $showverify = true;?><?php if(is_array($_G['setting']['verify'])) foreach($_G['setting']['verify'] as $vid => $verify) { if($verify['available']) { if($showverify) { $showverify = false;?><?php } if($space['verify'.$vid] == 1) { ?>
...
<?php } } } if(!$showverify) { } } ?>
<li style="display: inline-block; margin-left: 10px;"><span style="color:<?php echo $space['group']['color'];?>"<?php if($upgradecredit !== false) { ?> class="xi2" onmouseover="showTip(this)" tip="积分 <?php echo $space['credits'];?>, 距离下一级还需 <?php echo $upgradecredit;?> 积分"<?php } ?>><a href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=<?php echo $space['groupid'];?>" target="_blank" style="color: #BBBBBB;"><?php echo $space['group']['grouptitle'];?></a></span> <?php echo $space['group']['icon'];?> <?php if(!empty($space['groupexpiry'])) { ?>&nbsp;有效期至&nbsp;<?php echo dgmdate($space[groupexpiry], 'Y-m-d H:i');?><?php } ?></li>
...
<?php } ?>
<ul class="pf_l cl"><?php if(is_array($profiles)) foreach($profiles as $value) { ?><li style="color: #ffa000;"><em><?php echo $value['title'];?></em><?php echo $value['value'];?></li>
<?php } ?>
</ul>
</div>
<?php if(CURMODULE == 'space') { ?>
...
<?php if($space['oltime']) { ?><li style="width: 267px; padding: 10px; background: #F3F3F3;"><em>在线时间</em><?php echo $space['oltime'];?> 小时</li><?php } ?>
<li style="width: 267px; padding: 10px; background: #FAFAFA;"><em>注册时间</em><?php echo $space['regdate'];?></li>
<li style="width: 267px; padding: 10px; background: #F3F3F3;"><em>最后访问</em><?php echo $space['lastvisit'];?></li>

<li style="width: 267px; padding: 10px; background: #FAFAFA;"><em>注册 IP</em><?php echo $space['regip'];?> - <?php echo $space['regip_loc'];?></li>
<li style="width: 267px; padding: 10px; background: #FAFAFA;"><em>上次访问 IP</em><?php echo $space['lastip'];?>:<?php echo $space['port'];?> - <?php echo $space['lastip_loc'];?></li>

<?php if($space['lastactivity']) { ?><li style="width: 267px; padding: 10px; background: #F3F3F3;"><em>上次活动时间</em><?php echo $space['lastactivity'];?></li><?php } if($space['lastpost']) { ?><li style="width: 267px; padding: 10px; background: #FAFAFA;"><em>上次发表时间</em><?php echo $space['lastpost'];?></li><?php } ?>
<li style="width: 267px; padding: 10px; background: #F3F3F3;"><em>所在时区</em><?php $timeoffset = array(
		'9999' => '使用系统默认',
