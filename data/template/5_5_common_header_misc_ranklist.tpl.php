...
0
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/header_common.htm', 1584742429, '5', './data/template/5_5_common_header_misc_ranklist.tpl.php', './template/quater_6_motion', 'common/header_misc_ranklist')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/quater_6_motion/common/pubsearchform.htm', 1584742429, '5', './data/template/5_5_common_header_misc_ranklist.tpl.php', './template/quater_6_motion', 'common/header_misc_ranklist')
|| checktplrefresh('./template/quater_6_motion/common/header.htm', './template/default/common/header_qmenu.htm', 1584742429, '5', './data/template/5_5_common_header_misc_ranklist.tpl.php', './template/quater_6_motion', 'common/header_misc_ranklist')
;?>
<!DOCTYPE html>
<html>
<head>
