...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1584733802, '6', './data/template/6_6_common_header_home_space.tpl.php', './template/comiis_app', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1584733802, '6', './data/template/6_6_common_header_home_space.tpl.php', './template/comiis_app', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1584733802, '6', './data/template/6_6_common_header_home_space.tpl.php', './template/comiis_app', 'common/header_home_space')
;?>
