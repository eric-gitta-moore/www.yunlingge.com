...
<div class="comiis_mhicos comiis_mhico<?php echo $data['id'];?>">
<ul class="swiper-wrapper">
        <?php echo $comiis['summary'];?>
</ul>
<div class="comiis_mhico_rolls comiis_mhico_roll<?php echo $data['id'];?>"></div>
</div>
<script>
comiis_app_portal_swiper('.comiis_mhico<?php echo $data['id'];?>', {
        pagination: '.comiis_mhico_roll<?php echo $data['id'];?>',
