...
0
|| checktplrefresh('./template/quater_6_motion/ranklist/ranklist.htm', './template/default/ranklist/side_left.htm', 1584742429, 'diy', './data/template/5_diy_ranklist_ranklist.tpl.php', './template/quater_6_motion', 'ranklist/ranklist')
...
<span>&middot;</span> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>" target="_blank"><?php echo $thread['subject'];?></a>
</li>
<?php } ?>
</ul>
</div>
...
<span>&middot;</span> <a href="home.php?mod=space&amp;uid=<?php echo $blog['uid'];?>&amp;do=blog&amp;id=<?php echo $blog['blogid'];?>" target="_blank"><?php echo $blog['subject'];?></a>
</li>
<?php } ?>
</ul>
</div>
...
<span>&middot;</span> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $poll['tid'];?>" target="_blank"><?php echo $poll['subject'];?></a>
</li>
<?php } ?>
</ul>
</div>
...
<span>&middot;</span> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $activity['tid'];?>" target="_blank"><?php echo $activity['subject'];?></a>
</li>
<?php } ?>
</ul>
</div>
...
<!--[diy=diyranklistbottom]--><div id="diyranklistbottom" class="area"></div><!--[/diy]--><?php include template('common/footer'); ?><?php if(function_exists('yunling_redirect_resource_output')){yunling_redirect_resource_output('doNotMove');}?>