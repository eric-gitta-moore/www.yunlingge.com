...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1584738735, '5', './data/template/5_5_search_portal.tpl.php', './template/quater_6_motion', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/quater_6_motion/search/pubsearch.htm', 1584738735, '5', './data/template/5_5_search_portal.tpl.php', './template/quater_6_motion', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1584738735, '5', './data/template/5_5_search_portal.tpl.php', './template/quater_6_motion', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1584738735, '5', './data/template/5_5_search_portal.tpl.php', './template/quater_6_motion', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/quater_6_motion/common/header_common.htm', 1584738735, '5', './data/template/5_5_search_portal.tpl.php', './template/quater_6_motion', 'search/portal')
;?>
<!DOCTYPE html>
<html>
<head>
...
<tr>
<td><h1><img src="/template/quater_6_motion/src/logo2.png" /></h1></td>
<td>
...
<div class="hm" style="padding: 20px 0; margin: 0 -20px 20px -20px; background: #F0F0F0;">
           <img src="/template/quater_6_motion/src/logo2.png" />
        </div>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['portal_top'])) echo $_G['setting']['pluginhooks']['portal_top'];?>
...
<?php } if(function_exists('yunling_redirect_resource_output')){yunling_redirect_resource_output();}?></body>
</html>