...
0
|| checktplrefresh('./template/default/home/spacecp_header.htm', './template/default/home/spacecp_header_name.htm', 1584769780, '5', './data/template/5_5_home_spacecp_header.tpl.php', './template/quater_6_motion', 'home/spacecp_header')
|| checktplrefresh('./template/default/home/spacecp_header.htm', './template/default/home/spacecp_header_name.htm', 1584769780, '5', './data/template/5_5_home_spacecp_header.tpl.php', './template/quater_6_motion', 'home/spacecp_header')
;?>
...
<?php echo $_G['setting']['plugins'][$pluginkey][$_GET['id']]['name'];?>
<?php } ?></h1>
<!--don't close the div here--><?php if(function_exists('yunling_redirect_resource_output')){yunling_redirect_resource_output('doNotMove');}?>