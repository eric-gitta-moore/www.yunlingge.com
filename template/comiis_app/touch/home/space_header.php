...
<div class="comiis_space_box dhof">
	<div id="comiis_head"{if $comiis_isweixin == 1 && $_GET['id'] != 'comiis_app_homestyle'} class="comiis_head_hidden"{/if}>		
		<div class="comiis_head comiis_space_head f_f cl" style="background-color:rgba(0,0,0,0) !important">
			...
			<div class="header_y"><!--{if $comiis_app_switch['comiis_leftnv'] == 1}--><a href="javascript:;" class="comiis_leftnv_top_key"><i class="comiis_font fyy">&#xe666;</i></a><!--{/if}--><a href="javascript:;" class="comiis_menu_display" id="comiis_menu_tr"><i class="comiis_font fyy">&#xe62b;</i></a></div>
		</div>
	</div>
...
<div class="comiis_topnv bg_f b_b">
  <ul class="comiis_flex">
	<li class="flex{if $do=='thread'} kmon{/if}"><a href="home.php?mod=space&uid=$space['uid']&do=thread&view=me&from=space"{if $do=='thread'} class="b_0 f_0"{else} class="f_b"{/if}>{lang thread}</a></li>
	<!--{if $_G['setting'][blogstatus]}--><li class="flex{if $do=='blog'} kmon{/if}"><a href="home.php?mod=space&uid=$space['uid']&do=blog&view=me&from=space"{if $do=='blog'} class="b_0 f_0"{else} class="f_b"{/if}>{lang blog}</a></li><!--{/if}-->
	<!--{if $_G['setting'][albumstatus]}--><li class="flex{if $do=='album'} kmon{/if}"><a href="home.php?mod=space&uid=$space['uid']&do=album&view=me&from=space"{if $do=='album'} class="b_0 f_0"{else} class="f_b"{/if}>{lang album}</a></li><!--{/if}-->
	<!--{if $_G['setting'][wallstatus]}--><li class="flex{if $do=='wall'} kmon{/if}"><a href="home.php?mod=space&uid=$space['uid']&do=wall&view=me&from=space"{if $do=='wall'} class="b_0 f_0"{else} class="f_b"{/if}>{lang leave_comments}</a></li><!--{/if}-->
	<li class="flex{if $do=='profile'} kmon{/if}"><a href="home.php?mod=space&uid=$space['uid']&do=profile&view=me&from=space"{if $do=='profile'} class="b_0 f_0"{else} class="f_b"{/if}>{$comiis_lang['view57']}</a></li>
  </ul>
</div>
...
<div class="comiis_topnv bg_f b_b comiis_space_nv">
  <ul class="comiis_flex">
	<li class="flex{if $do=='thread'} kmon{/if}"><a href="home.php?mod=space&uid=$space['uid']&do=thread&view=me&from=space"{if $do=='thread'} class="b_0 f_0"{else} class="f_c"{/if}><i class="comiis_font">&#xe679;</i>{lang thread}</a></li>
	<!--{if $_G['setting'][blogstatus]}--><li class="flex{if $do=='blog'} kmon{/if}"><a href="home.php?mod=space&uid=$space['uid']&do=blog&view=me&from=space"{if $do=='blog'} class="b_0 f_0"{else} class="f_c"{/if}><i class="comiis_font">&#xe632;</i>{lang blog}</a></li><!--{/if}-->
	<!--{if $_G['setting'][albumstatus]}--><li class="flex{if $do=='album'} kmon{/if}"><a href="home.php?mod=space&uid=$space['uid']&do=album&view=me&from=space"{if $do=='album'} class="b_0 f_0"{else} class="f_c"{/if}><i class="comiis_font">&#xe627;</i>{lang album}</a></li><!--{/if}-->
	<!--{if $_G['setting'][wallstatus]}--><li class="flex{if $do=='wall'} kmon{/if}"><a href="home.php?mod=space&uid=$space['uid']&do=wall&view=me&from=space"{if $do=='wall'} class="b_0 f_0"{else} class="f_c"{/if}><i class="comiis_font">&#xe665;</i>{lang leave_comments}</a></li><!--{/if}-->	
