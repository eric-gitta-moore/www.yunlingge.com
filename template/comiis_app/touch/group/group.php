	...
	<div class="comiis_bigtop_box bg_0" style="background-image:url({if $_G[forum][banner]}$_G[forum][banner]{else}template/comiis_app/comiis/img/group_bg.jpg{/if}) !important;background-repeat:no-repeat;background-position:center;background-size:cover !important;">
		<div id="comiis_head"{if $comiis_isweixin == 1} class="comiis_head_hidden"{/if}>
			<div class="comiis_tmhead comiis_space_head f_f cl">
				...
				<h2>$_G[forum][name]</h2>
				<div class="header_y"><!--{if $comiis_app_switch['comiis_leftnv'] == 1}--><a href="javascript:;" class="comiis_leftnv_top_key"><i class="comiis_font">&#xe666;</i></a><!--{/if}--><a href="javascript:;" class="comiis_menu_display" id="comiis_menu_gvtr"><i class="comiis_font">&#xe62b;</i></a><!--{if $comiis_app_switch['comiis_leftnv'] != 1}--><a href="search.php?mod=group"><i class="comiis_font">&#xe622;</i></a><!--{/if}--></div>
			</div>
		</div>
